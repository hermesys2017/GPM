...
#                 self.gpm_canvas.setLayerSet([QgsMapCanvasLayer(base_shp)])
    ...
    def Make_png_menu(self):
        try:
            ...
            vectorLayer_line = self.shp_layer_line;
            vectorLayer_point= self.shp_layer_point
...
#             QgsMessageLog.logMessage(str(self.txt_userID.text())+"\n"+str(self.txt_userPW.text()),"GPM WGET")
            ...
            wget.create_bat_script(userId,userPw,self.start_date.text(),self.end_date.text(),wget_folder)
